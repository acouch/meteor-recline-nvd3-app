...
Package.onUse(function(api) {
  ...
  api.addFiles('public/nvd3_visualization_app/public/bootstrap/dist/css/bootstrap.min.css', 'client');
  api.addFiles('public/nvd3_visualization_app/public/slickgrid/slick.grid.css', 'client');
  api.addFiles('public/nvd3_visualization_app/public/chosen-bootstrap/chosen.bootstrap.css', 'client');
  ...
  api.addFiles('public/nvd3_visualization_app/public/nvd3/build/nv.d3.css', 'client');
  ...
  api.addFiles('recline-nvd3-app-csv.js', 'client', {bare: true});
